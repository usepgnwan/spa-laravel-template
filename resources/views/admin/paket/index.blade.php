<div class="pagetitle">
  ...
  <script>
    ...
    $('.packet-body').on('click','.creatData, .edit-data',function(e){
        e.preventDefault();
        let id = $(this).data('id');
        let url = "{{route('paket.modal',['opt'=> ':id'])}}";
    ...
    $('.packet-body').on('click','.delete-data',function(e){
        let id = $(this).data('id') 
        let url ="{{ route('paket.delete',['opt'=>':id']) }}";
        url = url.replace(":id", id);
